...
function emitLineDiff(diffMD, linesA, linesC, outputStream) {
  ...
  for (const hunk of hunks) {
    ...
    emitPatchLines(' ', linesA, firstLineAt, peekDistanceStart, outputStream);
    ...
    emitPatchLines(' ', linesA, lastLinesBeginAt, lastLinesNum, outputStream);
  }
}
module.exports.emitLineDiff = emitLineDiff;

function emitPatch(linesA, linesC, params, outputStream) {
...
module.exports.emitPatch = emitPatch;
