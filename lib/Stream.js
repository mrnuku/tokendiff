...
function isEmptyStream(lines) {
  return lines.length == 1 && lines[0] === '';
}
module.exports.isEmptyStream = isEmptyStream;

function hasOnlyOneNewlineStream(lines) {
  return lines.length == 2 && lines[0] === '' && lines[1] === '';
}
module.exports.hasOnlyOneNewlineStream = hasOnlyOneNewlineStream;
